...
function LoadUI(Hub)
    ...
    spawn(function()
        ...
        Loading.Text = "Loaded"
        wait(.8)
        Loading.Text = "Welcome to Miku Hub"
        wait(.2)
...
_G.SaveSetting = {
   ...
   function LoadSettings()
	   if readfile and writefile and isfile and isfolder then
		   if not isfolder("Lua Hub Premium Scripts") then
			   makefolder("Lua Hub Premium Scripts")
		   end
		   if not isfolder("Lua Hub Premium Scripts/Blox Fruits/") then
			   makefolder("Lua Hub Premium Scripts/Blox Fruits/")
		   end
		   if not isfile("Lua Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			   writefile("Lua Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.SaveSetting))
		   else
			   local Decode = game:GetService("HttpService"):JSONDecode(readfile("Lua Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
   ...
   function savesettings()
	   if readfile and writefile and isfile and isfolder then
		   if not isfile("Lua Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			   ...
			   writefile("Lua Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		   end
	   else
		   return warn("Status : Undetected Executor")
	   end
...
function setwatermarktime()
    ...
    Library:SetWatermark("Lua Hub | v.1 | "..hr.." Hour(hr) "..min.." Minute(m) "..sec.." Second(s)")
 end
...
local Window = Library:CreateWindow({
    Title = 'Lua Hub | Community Beta Scripts',
    Center = true, 
    AutoShow = true,
})
task.spawn(function()
	while task.wait() do
		Library:AttemptSave()
		Window:SetWindowTitle("Lua Hub | Beta Scripts - "..os.date('%A, %B %d %Y at %H:%M:%S'))
	end
end)
local Tabs = {
    -- Creates a new tab titled Main
    ['info'] = Window:AddTab('Informations'), 
...
----------------------------------------
local InfoNews = InfoBox:AddTab('News')
InfoNews:AddLabel('Updated!! v.1.8.28-12-22')
InfoNews:AddDivider()
InfoNews:AddLabel('[Fix] Auto Raid')
InfoNews:AddLabel('[Improve] Auto Raid')
---------------------------------
    ...
    function()
        while task.wait() do
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 1 then
                DeathStep:SetText("✅ : Death Step"..game.Players.LocalPlayer.Backpack:FindFirstChild("Death Step").Level.Value)
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) == 1 then
                SharkmanKarate:SetText("✅ : Sharkman Karate"..game.Players.LocalPlayer.Backpack:FindFirstChild("Sharkman Karate").Level.Value)
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw", true) == 1 then
                ElectricClaw:SetText("✅ : Electric Claw"..game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw").Level.Value)
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon", true) == 1 then
                DragonTalon:SetText("✅ : Dragon Talon"..game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon").Level.Value)
            end
            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodHuman", true) == 1 then
                GodHuman:SetText("✅ : God Human"..game.Players.LocalPlayer.Backpack:FindFirstChild("God Human").Level.Value)
            end
        end
    end
)
...
local Event = MeterialsBox:AddTab('Event!!')
local CandyCheck = Event:AddLabel("Hello")
task.spawn(
    function()
        pcall(
            function()
...
Library:Notify('Lua Hub | Rejoin Server in 3',1)
wait(1)
Library:Notify('Lua Hub | Rejoin Server in 2',1)
wait(1)
Library:Notify('Lua Hub | Rejoin Server in 1',1)
wait(1)
Library:Notify('Lua Hub | Rejoin Server Go!!',1)
game:GetService("TeleportService"):Teleport(game.PlaceId)

end)
ServerTp:AddButton('Hop Server', function()
Library:Notify('Miku Hub | Hop Server in 3',1)
wait(1)
Library:Notify('Miku Hub | Hop Server in 2',1)
wait(1)
Library:Notify('Miku Hub | Hop Server in 1',1)
wait(1)
Library:Notify('Miku Hub | Hop Server Go!!',1.5)
    ServerHop()
end)
ServerTp:AddButton('Teleport Sea 1', function()
Library:Notify('Miku Hub | Teleport Sea 1 in 3 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 1 in 2 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 1 in 1 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 1 Go!!',1)
game:GetService("ReplicatedStorage").Remotes.CommF:InvokeServer("TravelMain")
end)
ServerTp:AddButton('Teleport Sea 2', function()
Library:Notify('Miku Hub | Teleport Sea 2 in 3 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 2 in 2 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 2 in 1 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 2 Go!!',1)
game:GetService("ReplicatedStorage").Remotes.CommF:InvokeServer("TravelDressrosa")
end)
ServerTp:AddButton('Teleport Sea 3', function()
Library:Notify('Miku Hub | Teleport Sea 3 in 3 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 3 in 2 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 3 in 1 sec',1)
wait(1)
Library:Notify('Miku Hub | Teleport Sea 3 Go!!',1)
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
end)
...
SettingGeneral:AddDropdown('FastAttackMode', {
    ...
    Multi = false,
    Text = 'Attacks Mode',
	Tooltip = 'Select Fast Attack Modes!',
})
...
ThemeManager:SetFolder('Miku Hub Theme Save')
SaveManager:SetFolder('Miku Hub Theme Save /Blox Fruit')
