...
Library:Notify('Lua Hub | Hop Server in 3',1)
wait(1)
Library:Notify('Lua Hub | Hop Server in 2',1)
wait(1)
Library:Notify('lua Hub | Hop Server in 1',1)
wait(1)
Library:Notify('Lua Hub | Hop Server Go!!',1.5)
    ServerHop()
end)
ServerTp:AddButton('Teleport Sea 1', function()
Library:Notify('Lua Hub | Teleport Sea 1 in 3 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 1 in 2 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 1 in 1 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 1 Go!!',1)
game:GetService("ReplicatedStorage").Remotes.CommF:InvokeServer("TravelMain")
end)
ServerTp:AddButton('Teleport Sea 2', function()
Library:Notify('Lua Hub | Teleport Sea 2 in 3 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 2 in 2 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 2 in 1 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 2 Go!!',1)
game:GetService("ReplicatedStorage").Remotes.CommF:InvokeServer("TravelDressrosa")
end)
ServerTp:AddButton('Teleport Sea 3', function()
Library:Notify('Lua Hub | Teleport Sea 3 in 3 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 3 in 2 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 3 in 1 sec',1)
wait(1)
Library:Notify('Lua Hub | Teleport Sea 3 Go!!',1)
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
end)
